...
#todo: enable iwyu after the iwyu issue "Assertion `Loc.isValid()' failed" fixed
cmake_config_command="cmake -DOPTION_DISABLE_IWYU=ON -DCMAKE_BUILD_TYPE=${opt_build_type} -DCMAKE_TOOLCHAIN_FILE=${THIS_DIR}/../../CMake/Toolchain/ToolchainClang.cmake -DCONFIG_BOARD=rpi3 -GNinja ${THIS_DIR}/../.."
