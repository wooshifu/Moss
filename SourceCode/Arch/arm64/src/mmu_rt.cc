...
extern_C void __asm_invalidate_icache_all(void);
extern_C void __asm_flush_dcache_all(void);
extern_C int __asm_flush_l3_cache(void);
extern_C void __asm_flush_dcache_range(unsigned long long start, unsigned long long end);
extern_C void __asm_invalidate_dcache_all(void);
extern_C void __asm_invalidate_icache_all(void);
