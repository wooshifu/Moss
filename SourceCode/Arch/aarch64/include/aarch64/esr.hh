...
#define ESR_ELx_IL       (1) <UL ESR_ELx_IL_SHIFT)
#define ESR_ELx_ISS_MASK (ESR_ELx_IL - 1)

/* ISS field definitions shared by different classes */
#define ESR_ELx_WNR_SHIFT (6)
#define ESR_ELx_WNR       (1) <UL ESR_ELx_WNR_SHIFT)

/* Asynchronous Error Type */
#define ESR_ELx_IDS_SHIFT (24)
#define ESR_ELx_IDS       (1) <UL ESR_ELx_IDS_SHIFT)
#define ESR_ELx_AET_SHIFT (10)
#define ESR_ELx_AET       (0x7UL << ESR_ELx_AET_SHIFT)

#define ESR_ELx_AET_UC  (0) <UL ESR_ELx_AET_SHIFT)
#define ESR_ELx_AET_UEU (1) <UL ESR_ELx_AET_SHIFT)
#define ESR_ELx_AET_UEO (2) <UL ESR_ELx_AET_SHIFT)
#define ESR_ELx_AET_UER (3) <UL ESR_ELx_AET_SHIFT)
#define ESR_ELx_AET_CE  (6) <UL ESR_ELx_AET_SHIFT)

/* Shared ISS field definitions for Data/Instruction aborts */
#define ESR_ELx_SET_SHIFT (11)
#define ESR_ELx_SET_MASK    (3) <UL ESR_ELx_SET_SHIFT)
#define ESR_ELx_FnV_SHIFT (10)
#define ESR_ELx_FnV         (1) <UL ESR_ELx_FnV_SHIFT)
#define ESR_ELx_EA_SHIFT (9)
#define ESR_ELx_EA          (1) <UL ESR_ELx_EA_SHIFT)
#define ESR_ELx_S1PTW_SHIFT (7)
#define ESR_ELx_S1PTW       (1) <UL ESR_ELx_S1PTW_SHIFT)
...
#define ESR_ELx_ISV       (1) <UL ESR_ELx_ISV_SHIFT)
#define ESR_ELx_SAS_SHIFT (22)
#define ESR_ELx_SAS       (3) <UL ESR_ELx_SAS_SHIFT)
#define ESR_ELx_SSE_SHIFT (21)
#define ESR_ELx_SSE       (1) <UL ESR_ELx_SSE_SHIFT)
#define ESR_ELx_SRT_SHIFT (16)
#define ESR_ELx_SRT_MASK  (0x1FUL << ESR_ELx_SRT_SHIFT)
#define ESR_ELx_SF_SHIFT  (15)
#define ESR_ELx_SF        (1) <UL ESR_ELx_SF_SHIFT)
#define ESR_ELx_AR_SHIFT (14)
#define ESR_ELx_AR        (1) <UL ESR_ELx_AR_SHIFT)
#define ESR_ELx_CM_SHIFT (8)
#define ESR_ELx_CM        (1) <UL ESR_ELx_CM_SHIFT)

/* ISS field definitions for exceptions taken in to Hyp */
#define ESR_ELx_CV           (1) <UL 24)
#define ESR_ELx_COND_SHIFT (20)
#define ESR_ELx_COND_MASK  (0xFUL << ESR_ELx_COND_SHIFT)
#define ESR_ELx_WFx_ISS_TI   (1) <UL 0)
#define ESR_ELx_WFx_ISS_WFI  (0) <UL 0)
#define ESR_ELx_WFx_ISS_WFE  (1) <UL 0)
#define ESR_ELx_xVC_IMM_MASK ((1UL << 16) - 1)

#define DISR_EL1_IDS (1) <UL 24)
/*
...
#define ESR_ELx_SYS64_ISS_RES0_MASK  (0x7UL << ESR_ELx_SYS64_ISS_RES0_SHIFT)
#define ESR_ELx_SYS64_ISS_DIR_MASK   0x1
#define ESR_ELx_SYS64_ISS_DIR_READ   0x1
#define ESR_ELx_SYS64_ISS_DIR_WRITE  0x0

#define ESR_ELx_SYS64_ISS_RT_SHIFT  5
#define ESR_ELx_SYS64_ISS_RT_MASK   (0x1fUL << ESR_ELx_SYS64_ISS_RT_SHIFT)
#define ESR_ELx_SYS64_ISS_CRM_SHIFT 1
#define ESR_ELx_SYS64_ISS_CRM_MASK  (0xfUL << ESR_ELx_SYS64_ISS_CRM_SHIFT)
#define ESR_ELx_SYS64_ISS_CRN_SHIFT 10
#define ESR_ELx_SYS64_ISS_CRN_MASK  (0xfUL << ESR_ELx_SYS64_ISS_CRN_SHIFT)
#define ESR_ELx_SYS64_ISS_OP1_SHIFT 14
#define ESR_ELx_SYS64_ISS_OP1_MASK  (0x7UL << ESR_ELx_SYS64_ISS_OP1_SHIFT)
#define ESR_ELx_SYS64_ISS_OP2_SHIFT 17
#define ESR_ELx_SYS64_ISS_OP2_MASK  (0x7UL << ESR_ELx_SYS64_ISS_OP2_SHIFT)
#define ESR_ELx_SYS64_ISS_OP0_SHIFT 20
#define ESR_ELx_SYS64_ISS_OP0_MASK  (0x3UL << ESR_ELx_SYS64_ISS_OP0_SHIFT)
#define ESR_ELx_SYS64_ISS_SYS_MASK                                                                                     \
  (ESR_ELx_SYS64_ISS_OP0_MASK | ESR_ELx_SYS64_ISS_OP1_MASK | ESR_ELx_SYS64_ISS_OP2_MASK | ESR_ELx_SYS64_ISS_CRN_MASK | \
...
#define ESR_ELx_SYS64_ISS_SYS_MRS_OP_MASK                                                                              \
  (ESR_ELx_SYS64_ISS_OP0_MASK | ESR_ELx_SYS64_ISS_OP1_MASK | ESR_ELx_SYS64_ISS_CRN_MASK | ESR_ELx_SYS64_ISS_DIR_MASK)
...
#define ESR_ELx_FP_EXC_TFV (1) <UL 23)
...
#define ESR_ELx_CP15_32_ISS_RT_MASK   (0x1fUL << ESR_ELx_CP15_32_ISS_RT_SHIFT)
#define ESR_ELx_CP15_32_ISS_CRM_SHIFT 1
#define ESR_ELx_CP15_32_ISS_CRM_MASK  (0xfUL << ESR_ELx_CP15_32_ISS_CRM_SHIFT)
#define ESR_ELx_CP15_32_ISS_CRN_SHIFT 10
#define ESR_ELx_CP15_32_ISS_CRN_MASK  (0xfUL << ESR_ELx_CP15_32_ISS_CRN_SHIFT)
#define ESR_ELx_CP15_32_ISS_OP1_SHIFT 14
#define ESR_ELx_CP15_32_ISS_OP1_MASK  (0x7UL << ESR_ELx_CP15_32_ISS_OP1_SHIFT)
#define ESR_ELx_CP15_32_ISS_OP2_SHIFT 17
#define ESR_ELx_CP15_32_ISS_OP2_MASK  (0x7UL << ESR_ELx_CP15_32_ISS_OP2_SHIFT)
...
#define ESR_ELx_CP15_64_ISS_RT_MASK  (0x1fUL << ESR_ELx_CP15_64_ISS_RT_SHIFT)

#define ESR_ELx_CP15_64_ISS_RT2_SHIFT 10
#define ESR_ELx_CP15_64_ISS_RT2_MASK  (0x1fUL << ESR_ELx_CP15_64_ISS_RT2_SHIFT)

#define ESR_ELx_CP15_64_ISS_OP1_SHIFT 16
#define ESR_ELx_CP15_64_ISS_OP1_MASK  (0xfUL << ESR_ELx_CP15_64_ISS_OP1_SHIFT)
#define ESR_ELx_CP15_64_ISS_CRM_SHIFT 1
#define ESR_ELx_CP15_64_ISS_CRM_MASK  (0xfUL << ESR_ELx_CP15_64_ISS_CRM_SHIFT)
