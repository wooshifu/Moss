...
#ifdef __cplusplus
static_assert(MMU_PAGE_TABLE_ENTRIES_IDENT == 512);
#endif
...
#define MMU_PTE_PERMISSION_MASK (MMU_PTE_ATTR_AP_MASK | MMU_PTE_ATTR_UXN | MMU_PTE_ATTR_PXN)
...
#define MMU_MAIR_VAL                                                                                                   \
  (MMU_MAIR_ATTR0 | MMU_MAIR_ATTR1 | MMU_MAIR_ATTR2 | MMU_MAIR_ATTR3 | MMU_MAIR_ATTR4 | MMU_MAIR_ATTR5 |               \
...
#define MMU_TCR_FLAGS1                                                                                                 \
  (MMU_TCR_TG1(MMU_TG1(MMU_KERNEL_PAGE_SIZE_SHIFT)) | MMU_TCR_SH1(MMU_SH_INNER_SHAREABLE) |                            \
...
#define MMU_TCR_FLAGS0                                                                                                 \
  (MMU_TCR_TG0(MMU_TG0(MMU_USER_PAGE_SIZE_SHIFT)) | MMU_TCR_SH0(MMU_SH_INNER_SHAREABLE) |                              \
...
#define MMU_TCR_FLAGS_IDENT (MMU_TCR_IPS_DEFAULT | MMU_TCR_FLAGS1 | MMU_TCR_FLAGS0_IDENT | MMU_TCR_AS | MMU_TCR_A1)
...
#define MMU_TCR_FLAGS_USER (MMU_TCR_IPS_DEFAULT | MMU_TCR_FLAGS1 | MMU_TCR_FLAGS0 | MMU_TCR_AS)

#define MMU_VTCR_FLAGS_GUEST                                                                                           \
  (MMU_TCR_TG0(MMU_TG0(MMU_GUEST_PAGE_SIZE_SHIFT)) | MMU_TCR_SH0(MMU_SH_INNER_SHAREABLE) |                             \
   MMU_TCR_ORGN0(MMU_RGN_WRITE_BACK_ALLOCATE) | MMU_TCR_IRGN0(MMU_RGN_WRITE_BACK_ALLOCATE) |                           \
