...
//    adr_global x9, arm64_el2_init_table //todo
//    msr vbar_el2, x9
...
END_FUNCTION arm64_elX_to_el1
      ...
      :
      : [CURRENTEL_EL1] "i"(CURRENTEL_EL1),               // 0b01<<2
        [CURRENTEL_EL2] "i"(CURRENTEL_EL2),               // 0b10<<2
        [SCR_EL3_NS] "i"(SCR_EL3_NS),                     // 1<<0
        [SCR_EL3_HCE] "i"(SCR_EL3_HCE),                   // 1<<8
        [SCR_EL3_RW] "i"(SCR_EL3_RW),                     // 1<<10
        [SPSR_ELX_DAIF] "i"(SPSR_ELX_DAIF),               // 0b1111<<6
        [SPSR_ELX_EL1H] "i"(SPSR_ELX_EL1H),               // 0b0101
        [CNTHCTL_EL2_EL1PCEN] "i"(CNTHCTL_EL2_EL1PCEN),   // 1<<1
        [CNTHCTL_EL2_EL1PCTEN] "i"(CNTHCTL_EL2_EL1PCTEN), // 1<<0
        [CNTHCTL_EL2_EVNTEN] "i"(CNTHCTL_EL2_EVNTEN),     // 1<<2
        [ID_AA64PFR0_EL1_GIC] "i"(ID_AA64PFR0_EL1_GIC),   // 0b1111<<24
        [CPTR_EL2_RES1] "i"(CPTR_EL2_RES1),               // 0x33ff
        [CPACR_EL1_FPEN] "i"(CPACR_EL1_FPEN),             // 0b11<<20
        [ICC_SRE_EL2_ENABLE] "i"(ICC_SRE_EL2_ENABLE),     // 1<<3
        [ICC_SRE_EL2_SRE] "i"(ICC_SRE_EL2_SRE),           // 1<<0
        [HCR_EL2_RW] "i"(HCR_EL2_RW)                      // 1<<31
      : "cc", "memory");
}
