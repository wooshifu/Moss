...
#include "lib/counters.hh"
#include "lib/fit/defer.hh"
#include "lib/heap.hh"
#include "lib/instrumentation/asan.hh"
#include "lib/ktrace.hh"
#include "lib/lazy_init/lazy_init.hh"
#include "stdlib.hh"
#include "string.hh"
...
#include "arch/arm64/hypervisor/el2_state.hh"
#include "arch/aspace.hh"
#include "fbl/auto_lock.hh"
#include "kernel/mutex.hh"
#include "ktl/algorithm.hh"
#include "vm/arch_vm_aspace.hh"
#include "vm/physmap.hh"
#include "vm/pmm.hh"
#include "vm/vm.hh"

#include "asid_allocator.hh"
...
#define LOCAL_KTRACE(string, args...)                                                                                  \
  ktrace_probe(LocalTrace<LOCAL_KTRACE_ENABLE>, TraceContext::Cpu, KTRACE_STRING_REF(string), ##args)
