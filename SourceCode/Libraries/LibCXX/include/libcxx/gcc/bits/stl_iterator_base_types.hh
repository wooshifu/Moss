...
#include "libcxx/gcc/type_traits.hh" // For __void_t, is_convertible
#endif
...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  inline _GLIBCXX_CONSTEXPR typename iterator_traits<_Iter>::iterator_category __iterator_category(const _Iter&) {
