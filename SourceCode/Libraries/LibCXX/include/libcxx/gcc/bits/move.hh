...
#include "libcxx/gcc/type_traits.hh" // Brings in std::declval too.
...
#define _GLIBCXX_FORWARD(_Tp, __val) (__val)
  ...
  _GLIBCXX20_CONSTEXPR inline
      ...
      swap(_Tp & __a, _Tp & __b)
          _GLIBCXX_NOEXCEPT_IF(__and_<is_nothrow_move_constructible<_Tp>, is_nothrow_move_assignable<_Tp>>::value) {
#if __cplusplus < 201103L
  ...
  _GLIBCXX20_CONSTEXPR inline
      ...
      void
#endif
      swap(_Tp(&__a)[_Nm], _Tp(&__b)[_Nm]) _GLIBCXX_NOEXCEPT_IF(__is_nothrow_swappable<_Tp>::value) {
