...
namespace std {
  ...
  extern "C++" inline void __replacement_assert(const char* __file, int __line, const char* __function,
...
#include "os_defines.hh"

// Pick up any CPU-specific definitions.
#include "cpu_defines.hh"
...
// implementation.
    ...
    __cpp_transactional_memory >= 201500L && !_GLIBCXX_FULLY_DYNAMIC_STRING && _GLIBCXX_USE_WEAK_REF &&                \
