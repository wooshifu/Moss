...
#define __glibcxx_min(_Tp) (__glibcxx_signed(_Tp) ? -__glibcxx_max(_Tp) - 1 : (_Tp)0)

#define __glibcxx_max(_Tp)                                                                                             \
  (__glibcxx_signed(_Tp) ? (((((_Tp)1 << (__glibcxx_digits(_Tp) - 1)) - 1) << 1) + 1) : ~(_Tp)0)
...
#define __glibcxx_floating(_Tp, _Fval, _Dval, _LDval)                                                                  \
  (std::__are_same<_Tp, float>::__value ? _Fval : std::__are_same<_Tp, double>::__value ? _Dval : _LDval)
...
#define __glibcxx_max_exponent10(_Tp)                                                                                  \
  ...
  struct __numeric_traits
      : public __conditional_type<std::__is_integer<_Value>::__value, __numeric_traits_integer<_Value>,
