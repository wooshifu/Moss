function(setup_kconfig)
    ...
    if (NOT EXISTS ${Moss_SOURCE_DIR}/.config)
        ...
        execute_process(COMMAND ${Python3_EXECUTABLE}
                ${Moss_SOURCE_DIR}/KconfigLib/alldefconfig.py
                WORKING_DIRECTORY ${Moss_SOURCE_DIR}
                TIMEOUT 5)
    endif ()

    set(config_dir ${Moss_SOURCE_DIR}/SourceCode/Config)
    set(genconfig_command ${Moss_SOURCE_DIR}/KconfigLib/genconfig.py
    ...
    add_custom_target(alldefconfig.py
            ...
            COMMAND ${Python3_EXECUTABLE} ${Moss_SOURCE_DIR}/KconfigLib/alldefconfig.py
            WORKING_DIRECTORY ${Moss_SOURCE_DIR})
