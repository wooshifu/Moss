...
function(read_arch_from_arch_file IN_board OUT_arch)
    if (NOT EXISTS ${MOSS_SOURCE_CODE_DIR}/Board/${IN_board}/.arch)
        message(FATAL_ERROR "file .arch not found in directory ${MOSS_SOURCE_CODE_DIR}/Board/${IN_board}")
    endif ()

    file(STRINGS ${MOSS_SOURCE_CODE_DIR}/Board/${IN_board}/.arch lines)
